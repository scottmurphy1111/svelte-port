...
<svg
	class="w-[250px] opacity-0 transition-all duration-1000 ease-out"
	class:!opacity-100={globalState.introAnimationStart}
	version="1.1"
	id="Layer_1"
...
>
	<path
		class="animate-gearSpin origin-center fill-white opacity-10 transition-transform duration-1000 ease-in"
...
L325.1,169z M164,264.2c-55.2,0-100-44.8-100-100c0-55.2,44.8-100,100-100s100,44.8,100,100C264,219.4,219.2,264.2,164,264.2z"
	...
	<path
		class="fill-primaryBlue opacity-100 transition-all duration-1000 ease-in-out"
		class:!opacity-0={globalState.introAnimationComplete}
...
c0.7,0.8,2.1,1.2,4.2,1.2h3.9c0.2,0,0.3,0.1,0.3,0.3v6.1C121.2,194.3,121.1,194.4,120.9,194.4z"
	/>
	<path
		class="fill-white opacity-100 transition-all duration-1000 ease-in-out"
		class:!opacity-0={globalState.introAnimationComplete}
